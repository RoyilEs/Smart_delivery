...
type User struct {
	gorm.Model
	Username    string     `json:"username" gorm:"type:varchar(20);"`          //用户名
	...
	Token       string     `json:"token" gorm:"type:varchar(255);"`            //其他平台的唯一地址
	LastLoginAt string     `json:"last_login_at" gorm:"type:varchar(255);"`    //最后登录时间
